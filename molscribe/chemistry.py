...
def _convert_graph_to_smiles(coords, symbols, edges, image=None, debug=False):
    ...
    for i in range(n):
        symbol = symbols[i]
        symbol = symbol.replace("WOMO","MOMO").replace("MOWO","MOMO").replace("OWOM","OMOM").replace("OMM", "OMOM").replace("TlMSO","TMSO").replace("NHAloc","NHAlloc").replace("Alboc","Alloc").replace("Aloc","Alloc").replace("FmodHN", "FmocHN").replace("TlPSO", "TIPSO").replace("NTlPS", "NTIPS").replace("NTlS", "NTIPS").replace("TlPS", "TIPS").replace("OTlPS", "OTIPS").replace("OTiPS", "OTIPS").replace("TiPSO", "TIPSO").replace("CONH+", "CONH2").replace("NiBu", "NtBu").replace("NHHPh", "NHPh").replace("NHH", "NH").replace("OPv","OPiv").replace("TlPS", "TIPS").replace("TTBDPS", "TBDPS").replace("OSiMe2fBu", "OSiMe2tBu").replace("OsSiMe2fBu", "OSiMe2tBu").replace("SiMe2fBu", "SiMe2tBu").replace("(O)Pr)2B", "(OiPr)2B").replace("OSi((Pr))3", "OSi(iPr)3").replace("Teooc", "Teoc").replace("NCO2HMe", "NCO2Me").replace("NTeocc", "NTeoc").replace("TiO", "TfO").replace("DIP", "DIPP").replace("DlP", "DIPP").replace("PPD", "PPID").replace("OTBx", "OTBS").replace("TESOO", "TESO").replace("TESSO", "TESO").replace("NHSO2Ar", "NNHSO2Ar").replace("NHO2Bn", "NHCO2Bn").replace("SOfBu", "SOtBu").replace("Ort-Bu", "Ot-Bu").replace("STri", "STrt").replace("DlPP", "DIPP").replace("OSiMe2Buf", "OSiMe2But").replace("THPhO", "THPO").replace("CO2Buf", "CO2But").replace("PsOH", "pTsOH").replace("Br(CH3)4O", "Br(CH2)4O").replace("DlP", "DIPP").replace("Si(Er)3", "Si(Et)3").replace("NHAlHoc", "NHAlloc").replace("MeOOOCO", "MeOOCO").replace("BociN", "BocHN").replace("SToI", "STol").replace("STod", "STol").replace("TocHN", "TrocHN").replace("SAca", "SAda").replace("LavO", "LevO").replace("F(pIn)2B", "pinB").replace("F(pin)2B", "pinB").replace("CO2alJI", "CO2Allyl"). replace("CO2alIyI", "CO2Allyl"). replace("CO2alJ", "CO2Allyl").replace("BpIn", "Bpin").replace("DinB", "pinB").replace("PhB", "pinB").replace("DbB", "DMB").replace("C5H17", "C5H11").replace("C5H117", "C5H11").replace("OrBu", "OtBu").replace("OPtp", "OPfp").replace("NNNHTs", "NNHTs").replace("MOMeO", "MOMO").replace("TifH", "TfHN").replace("TifHN", "TfHN").replace("n-C8H19", "n-C9H19").replace("OTlTlPS", "OTIPS").replace("OTllPS", "OTIPS").replace("Tcoc", "Troc").replace("((MeO)2)OP", "(MeO)2OP").replace("MOMOM", "MOMO") #替换
        if symbol[0] == '[':
            symbol = symbol[1:-1]
        if symbol in RGROUP_SYMBOLS:
            atom = Chem.Atom("*")
